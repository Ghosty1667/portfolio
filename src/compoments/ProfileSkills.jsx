...
//                                 <li className="list-group-item mb-3">
//                                     <h5 className="text-transform">
//                                         <i className="fas fa-building text-primary"></i> Current Position:
//                                     </h5>
...
//                                 mean anything 😉
//                             </p>
//                             <h5><i className="fas fa-check"></i> HTML 5</h5>
//                             <div
...
//                             <h5><i className="fas fa-check"></i> CSS</h5>
//                             <div
//                                 className="progress mb-4"
//                                 role="progressbar"
//                                 aria-valuenow="90"
...
//                             <h5><i className="fas fa-check"></i> JavaScript</h5>
//                             <div
//                                 className="progress mb-4"
//                                 role="progressbar"
//                                 aria-valuenow="90"
...
//                             <h5><i className="fas fa-check"></i> Bootstrap</h5>
//                             <div
//                                 className="progress mb-4"
//                                 role="progressbar"
//                                 aria-valuenow="100"
...
//                             <h5><i className="fas fa-check"></i> PHP</h5>
//                             <div
//                                 className="progress mb-4"
//                                 role="progressbar"
//                                 aria-valuenow="75"
...
//                             <h5><i className="fas fa-check"></i> Python</h5>
//                             <div
//                                 className="progress mb-4"
//                                 role="progressbar"
//                                 aria-valuenow="70"
...
//                             <h5><i className="fas fa-check"></i> UI/UX</h5>
//                             <div
//                                 className="progress mb-4"
//                                 role="progressbar"
//                                 aria-valuenow="70"
